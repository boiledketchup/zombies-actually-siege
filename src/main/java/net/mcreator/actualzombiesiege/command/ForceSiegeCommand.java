...
package net.mcreator.actualzombiesiege.command;
...
public class ForceSiegeCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("zombiesiege").requires(s -> s.hasPermission(1)).executes(arguments -> {
