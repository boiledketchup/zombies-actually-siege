package net.mcreator.actualzombiesiege.network;
...
public class ActualZombieSiegeModVariables {
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "actual_zombie_siege_worldvars";
		public String configReturn = "\"\"";
		...
		public void read(CompoundTag nbt) {
			configReturn = nbt.getString("configReturn");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putString("configReturn", configReturn);
			return nbt;
		}
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level level && !level.isClientSide())
				ActualZombieSiegeMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(level::dimension), new SavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends SavedData {
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				ActualZombieSiegeMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
